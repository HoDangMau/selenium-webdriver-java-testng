...
public class Topic05_DataProvider {
	WebDriver driver;
	...
	public Object[][] registerData(Method method) {
		Object[][] obj = null;
		if (method.getName().contains("Register_System")) {
			obj = new Object[][] { { "demo" + getRandomNum() + "@mail.com", "123456" },
				{ "demo" + getRandomNum() + "@mail.com", "123456" },
				{ "demo" + getRandomNum() + "@mail.com", "123456" } };			
		}
